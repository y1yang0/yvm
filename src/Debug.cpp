    ...
    for (int i = 1; i <= jc.raw.constPoolCount - 1; i++) {
        ...
        if (typeid(*jc.raw.constPoolInfo[i]) == typeid(CONSTANT_Utf8)) {
            ...
            d.addCell((char*)jc.getString(
                dynamic_cast<CONSTANT_NameAndType*>(jc.raw.constPoolInfo[dynamic_cast<CONSTANT_Fieldref*>(jc
                                                                                                          .raw.
                                                                                                          constPoolInfo[
                    i])->nameAndTypeIndex])->nameIndex));
        }
        else if (typeid(*jc.raw.constPoolInfo[i]) == typeid(CONSTANT_Methodref)) {
            d.addCell((char*)jc.getString(
                dynamic_cast<CONSTANT_NameAndType*>(jc.raw.constPoolInfo[dynamic_cast<CONSTANT_Methodref*>(jc
                                                                                                           .raw.
                                                                                                           constPoolInfo
                    [i])->nameAndTypeIndex])->nameIndex));
        }
            ...
            d.addCell((char*)jc.getString(
                dynamic_cast<CONSTANT_NameAndType*>(jc.raw.constPoolInfo[dynamic_cast<CONSTANT_InterfaceMethodref*>(jc
                                                                                                                    .raw
                                                                                                                    .constPoolInfo
                    [i])->nameAndTypeIndex])->nameIndex));
        }
...
void Inspector::printInterfaces(const JavaClass& jc) {
    ...
    FOR_EACH(i, jc.raw.interfacesCount) {
        d.addCell("#" + std::to_string(i));
        d.addCell((char*)jc.getString(
            dynamic_cast<CONSTANT_Class*>(jc.raw.constPoolInfo[jc.raw.interfaces[i]])->nameIndex));
    }
    d.show();
}
