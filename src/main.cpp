...
int main(int argc, char *argv[]) {
    ...
    cparser.addFlag("rt", "runtime",
        "Attach java runtime libraries of this YVM.");
    ...
    if (needHelp) {
        std::cout << "Yvm - Yet another java Virtual Machine :)\n"
            ...
            "You must specify the \"runtime\" flag to tell yvm where it "
            "could find jdk classes, and also program name is required.\n";
        return 0;
    }
