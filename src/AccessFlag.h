...
#define IS_FIELD(ACC_NAME)\
    inline bool IS_FIELD_##ACC_NAME(int value)	{ return (value & (int)FieldAccess::ACC_##ACC_NAME) !=0;}
#define IS_METHOD(ACC_NAME)\
    inline bool IS_METHOD_##ACC_NAME(int value)	{ return (value & (int)MethodAccess::ACC_##ACC_NAME) !=0;}
#define IS_CLASS(ACC_NAME)\
    inline bool IS_CLASS_##ACC_NAME(int value)	{ return (value & (int)ClassAccess::ACC_##ACC_NAME) !=0;}
