    ...
    public void codes2Opcodes() throws ClassInitializingException {
        for (i = 0; i < codeRef.length; i++) {
            switch (codeRef[i].getValue()) {
                //Constants
                case Mnemonic.nop:
                    addOpcode(codeRef[i].getValue(), this::new0_Operand);
                    break;
                case Mnemonic.aconst_null:
                    addOpcode(codeRef[i].getValue(), this::new0_Operand);
                    break;
                case Mnemonic.iconst_m1:
                    addOpcode(codeRef[i].getValue(), this::new2Operand);
                    break;
                ...
                case Mnemonic.bipush:
                    addOpcode(codeRef[i].getValue(), this::new1Operand);
                    break;
                ...
                case Mnemonic.invokeinterface:
                    addOpcode(codeRef[i].getValue(), this::new4Operand);
                    break;
                ...
                case Mnemonic.multianewarray:
                    addOpcode(codeRef[i].getValue(), this::new3Operand);
                    break;
