...
public class Opcode {
    ...
    public void codes2Opcodes() throws ClassInitializingException {
        for (i = 0; i < codeRef.length; i++) {
            switch (codeRef[i].getValue()) {
                //Constants
                case Mnemonic.nop:
                    addOpcode(codeRef[i].getValue(), this::new$0$operand);
                    break;
                case Mnemonic.aconst_null:
                    addOpcode(codeRef[i].getValue(), this::new$0$operand);
                    break;
                case Mnemonic.iconst_m1:
                    addOpcode(codeRef[i].getValue(), this::new$2$operand);
                    break;
                ...
                case Mnemonic.bipush:
                    addOpcode(codeRef[i].getValue(), this::new$1$operand);
                    break;
                ...
                case Mnemonic.tableswitch:
                    ...
                    addOpcode(codeRef[i].getValue(), this::new$TableSwitch$operand);
                    break;
                case Mnemonic.lookupswitch:
                    ...
                    addOpcode(codeRef[i].getValue(), this::new$LookupSwitch$operand);
                    break;
                ...
                case Mnemonic.invokeinterface:
                    addOpcode(codeRef[i].getValue(), this::new$4$operand);
                    break;
                ...
                case Mnemonic.multianewarray:
                    addOpcode(codeRef[i].getValue(), this::new$3$operand);
                    break;
    ...
    private Operand new$LookupSwitch$operand() {
    ...
    private Operand new$TableSwitch$operand() {
